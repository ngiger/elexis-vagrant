...
* Point your browser at "http:://localhost:48080":http:://localhost:48080 and you should be able to see a running Jenkins
  [[images/vagrant_1.png]](running Jenkins)!
...
* Play with the jenkins. You may login as user elexis with the password elexisTest
...
* Support various versions of Eclipse
